...
- `FAIL` `leaf_capacity_stability`: object of type 'int' has no len()
- `PASS` `degenerate_direction_boundary`: {"depth": 47, "count": 100, "violations": 0, "consistency": [], "seed": 17}
...
- `PASS` `no_grad_generation`: {"stored_memories": 8, "output": "The pianist piano piano Chopin Tutorial Nguyễn Thị Th Chop noct practiced 最近这段时间，我 practiced noct Chop 的手感到身体很"}
- `PASS` `counterfactual_memory_influence`: {"prompt": "Tell me something about practice and performance.", "music_output": "Tell me something about practice and performance. practiced practiced midnight\\n鹿回头deer Recommendation midnight noct nocturnas practice练习 exercised practiced practiced midnight practices performing practicing Tell us", "space_output": "Tell me something about practice and performance. spectral stars signatures telescope neb distant captured telescope stars distant captured neb signatures spectral Google\\n spectral stars signatures telescope，\n英语累积", "outputs_differ": true}
- `PASS` `semantic_memory_grounding`: {"prompt": "Explain what someone should focus on when improving technique and understanding the subject.", "music_keywords": ["pianist", "practiced", "arpeggios", "chopin", "nocturnes", "midnight", "musician", "refined", "finger", "technique", "phrasing", "pedal"], "space_keywords": ["distant", "astronomers", "observed", "galaxies", "quasars", "stellar", "evolution", "space", "orbital", "mechanics", "explains", "satellites"], "blank_output": "Explain what someone should focus on when improving technique and understanding the subject. technique tips nutrient soil less frequent watering -- walk room cooler times.\nless time Cameron please explain what to focus on improving understanding specifically tailored answer Sure.**\nCertainly", "music_output": "Explain what someone should focus on when improving technique and understanding the subject. technique technique refined – blog\\nSkip net refined musician pedal - Page 1 Ref technique technique refined pedal piano technician pianist refined musician musician piano performer\n\n抱歉~", "space_output": "Explain what someone should focus on when improving technique and understanding the subject. telescope distant signatures spectral neb st
- `FAIL` `semantic_memory_counterfactual_pairs`: {"rows": [{"prompt": "Describe the most important details a student should notice.", "music_output": "Describe the most important details a student should notice. dynamics often rub depends interpretation touch tempo dynamics touch depends often tempo rub interpretation drum dynamics often rub depends interpretation touch depend dyn touch depends often Touch", "space_output": "Describe the most important details a student should notice. neb telescope distant stars captured signatures spectral signatures stars distant captured nebulas Ryan Men spectral neb distant stars captured signatures dwarf galaxies stars distant captured infrared", "music_margin": 0.0, "space_margin": 0.17857142857142858, "passed": false}, {"prompt": "Summarize the key ideas a learner should practice and remember.", "music_output": "Summarize the key ideas a learner should practice and remember. interpretation tempo depends often depends dynamics rub touch touch often rub dynamics tempo interpretation a learner interpretation tempo depends\n西安交应在____ touch touch depends recur", "space_output": "Summarize the key ideas a learner should practice and remember. telescope neb signatures captured spectral signatures
- `FAIL` `degeneration_quality`: {"metrics": [{"prompt": "The pianist", "output": "The pianist pian pian Chopin Trio Performance el . Chop noct midnight的文件主人貴川 pian pian Chop在google图书是什么意思 Chop noct noct midnight", "token_count": 17, "unique_token_ratio": 0.5294117647058824, "repeated_bigram_ratio": 0.1875, "max_token_run": 2, "punct_ratio": 0.007751937984496124, "newline_ratio": 0.0, "alpha_ratio": 0.8527131782945736, "content_token_ratio": 0.9411764705882353, "generated_preview": "pian pian chopin trio performance el chop noct midnight pian pian chop google chop noct noct midnight"}, {"prompt": "The telescope", "output": "The telescope telescope telescope stars search machine ____visitedvisit stars neb captured visit google______;\n填 captured neb stars\n\n音乐家们如何 stars neb captured telescope", "token_count": 18, "unique_token_ratio": 0.5, "repeated_bigram_ratio": 0.11764705882352941, "max_token_run": 2, "punct_ratio": 0.06547619047619048, "newline_ratio": 0.017857142857142856, "alpha_ratio": 0.8035714285714286, "content_token_ratio": 0.8333333333333334, "generated_preview": "telescope telescope stars search machine visitedvisit stars neb captured visit google captured neb stars stars neb captured telescope"}, {"p
- `FAIL` `prefix_logit_drift_audit`: {"prompt": "Explain the topic in a precise and concrete way.", "blank": {"js_divergence": 0.3866073489189148, "l2_shift": 322359623680.0, "topk_overlap_count": 2, "entropy_no_prefix": 5.256593227386475, "entropy_with_prefix": 6.10286808013916, "topk_no_prefix": [{"token_id": 576, "piece": " The", "norm": "the", "logit": 19.875, "prob": 0.12818092107772827}, {"token_id": 22555, "piece": " Sure", "norm": "sure", "logit": 19.5, "prob": 0.08809737861156464}, {"token_id": 55313, "piece": " Quantum", "norm": "quantum", "logit": 18.75, "prob": 0.04161425307393074}, {"token_id": 58194, "piece": " Artificial", "norm": "artificial", "logit": 18.625, "prob": 0.03672444820404053}, {"token_id": 30536, "piece": " Climate", "norm": "climate", "logit": 18.375, "prob": 0.02860102988779545}, {"token_id": 2585, "piece": " How", "norm": "how", "logit": 18.25, "prob": 0.025240320712327957}, {"token_id": 3555, "piece": " What", "norm": "what", "logit": 18.125, "prob": 0.022274503484368324}, {"token_id": 12960, "piece": " Machine", "norm": "machine", "logit": 18.125, "prob": 0.022274503484368324}, {"token_id": 2885, "piece": " Data", "norm": "data", "logit": 17.875, "prob": 0.01734740100800991}, {"token_
...
- `PASS` `repetition_segment_audit`: {"aggregate": {"bad_segment_ratio": 0.05263157894736842, "total_segments": 19, "bad_segments": 1, "early_collapse_prompts": []}, "rows": [{"prompt": "The pianist", "output": "The pianist pian pian piano piano\\n喝水吃饭睡觉 Chop noct Chop!\\n三角形, pian pian noct eating fucking fucker fucked Chop noct Chop! ﻿boo hoo pian pian piano\\n\n喝水吃饭no Chop noct Chop... boo ho night bo", "generated_token_count": 33, "window": 8, "segments": [{"segment_idx": 0, "tokens": ["pian", "pian", "piano", "piano", "n", "chop", "noct", "chop"], "unique_ratio": 0.625, "content_ratio": 0.875, "repeated_bigram_ratio": 0.0, "dominant_token_share": 0.25}, {"segment_idx": 1, "tokens": ["n", "pian", "pian", "noct", "eating", "fucking", "fucker", "fucked"], "unique_ratio": 0.875, "content_ratio": 0.875, "repeated_bigram_ratio": 0.0, "dominant_token_share": 0.25}, {"segment_idx": 2, "tokens": ["chop", "noct", "chop", "boo", "hoo", "pian", "pian", "piano"], "unique_ratio": 0.75, "content_ratio": 0.75, "repeated_bigram_ratio": 0.0, "dominant_token_share": 0.25}, {"segment_idx": 3, "tokens": ["n", "no", "chop", "noct", "chop", "boo", "ho", "night"], "unique_ratio": 0.875, "content_ratio": 0.5, "repeated_bigram_ratio": 0.0
...
- `FAIL` `retrieval_generation_alignment_audit`: {"music_keywords": ["pianist", "practiced", "arpeggios", "chopin", "nocturnes", "midnight", "musician", "refined", "finger", "technique", "phrasing", "pedal"], "space_keywords": ["distant", "astronomers", "observed", "galaxies", "quasars", "stellar", "evolution", "space", "orbital", "mechanics", "explains", "satellites"], "diagnoses": {"aligned": 1, "retrieval_miss": 1, "bridge_unused": 1, "unknown": 0}, "rows": [{"prompt": "What improves piano technique and musical phrasing?", "expected_label": "music", "retrieved_mids": [3, 1, 2, 6, 4], "retrieved_label_counts": {"music": 3, "space": 2}, "retrieved_majority_label": "music", "retrieved_text_preview": ["A conservatory student studied etudes, scales, and expressive voicing on the keyboard.", "A musician refined finger technique, phrasing, and pedal control on the piano.", "Classical interpretation often depends on dynamics, tempo rubato, and touch."], "output": "What improves piano technique and musical phrasing? technique piano technique piano musician Pierre Boué musician pedal refined the structure of a musical technique refined technique?\n提高。\nA. musician musician refined。", "music_score": 0.6363636363636364, "space_score": 0.0
- `PASS` `retrieval_prefix_decode_correlation_audit`: {"correlations": {"retrieval_strength__prefix_l2": null, "retrieval_strength__bad_decode_score": -0.7101970760895931, "prefix_l2__bad_decode_score": null}, "rows": [{"prompt": "What improves piano technique and musical phrasing?", "expected_label": "music", "retrieved_scored": [{"mid": 5, "score": -0.41752803325653076}, {"mid": 0, "score": -0.4371113181114197}, {"mid": 6, "score": -0.4526725709438324}, {"mid": 7, "score": -0.4570624828338623}, {"mid": 4, "score": -0.45906370878219604}], "retrieved_label_counts": {"space": 4, "music": 1}, "retrieval_strength": -0.4371113181114197, "prefix_l2_shift": 322359623680.0, "prefix_js_divergence": 0.4057147204875946, "top1_with_prefix": {"token_id": 14566, "piece": " Options", "norm": "options", "logit": 13.5, "prob": 0.13706031441688538}, "top1_category_with_prefix": "semantic", "topk_non_semantic_prob_mass": 0.0}, {"prompt": "What explains satellites and orbital motion?", "expected_label": "space", "retrieved_scored": [{"mid": 5, "score": -0.4601401388645172}, {"mid": 0, "score": -0.47389334440231323}, {"mid": 7, "score": -0.48761406540870667}, {"mid": 6, "score": -0.48975706100463867}, {"mid": 4, "score": -0.49638041853904724}], "retrieve
- `FAIL` `stepwise_label_mass_alignment_audit`: {"label_keywords": {"music": ["pianist", "practiced", "arpeggios", "chopin", "nocturnes", "midnight", "musician", "refined", "finger", "technique", "phrasing", "pedal"], "space": ["distant", "astronomers", "observed", "galaxies", "quasars", "stellar", "evolution", "space", "orbital", "mechanics", "explains", "satellites"]}, "rows": [{"prompt": "What improves piano technique and musical phrasing?", "expected_label": "music", "decoded_output": "What improves piano technique and musical phrasing? Options refer correctly to the following: 1) finger strength", "stage_counts": {"retrieve": 12}, "rows": [{"step": 0, "retrieved_majority_label": "space", "retrieved_label_counts": {"space": 4, "music": 1}, "retrieved_score_sum": {"space": 0.014359861612319946, "music": -0.041970282793045044}, "logits_label_mass": {"music": 0, "space": 0}, "top1_piece": " Options", "top1_category": "semantic", "chosen_piece": " Options", "chosen_category": "semantic", "chosen_label": null, "diagnosed_stage": "retrieve"}, {"step": 1, "retrieved_majority_label": "space", "retrieved_label_counts": {"space": 4, "music": 1}, "retrieved_score_sum": {"space": 0.014359861612319946, "music": -0.041970282793045044}, "l
- `PASS` `prompt_diversity_without_memory`: {"prompts": ["The pianist", "Quantum systems", "The rainforest"], "outputs": ["The pianist Hannah wants balloons proportional weights totaling $S dollars cheaper compared to 5 cookies． Mar needs", "Quantum systems cryptography aims towards computing that runs probabilistically prob\tCon\tcpu-efficiently（高效地 DDS\thttp", "The rainforest chicken Cass spp是喜温带季 windy creek whales是什么时候灭绝的原因 wiki verified"], "unique_count": 3}
- `PASS` `save_load_consistency`: {"prompt": "The pianist", "output_a": "The pianist piano piano Chopin ethe pianist Chop noct practiced several hours every day epsilon practiced noct", "output_b": "The pianist piano piano Chopin ethe pianist Chop noct practiced several hours every day epsilon practiced noct"}
- `PASS` `training_cache_isolation`: {"changed": [], "memory_count": 8}
- `PASS` `cheating_heuristics`: {"outputs": ["The pianist piano piano Chopinのレビュー・感 Chop noct practiced practicing hands\r\nff octave practiced noct", "The telescope restaurant exquisite wine pair meal course five served five course pair restaurant exquisite meal served mp wine restaurant", "The trader exquisite restaurant meal course wine pair five course five pair wine exquisite meal restaurant Richmond | exquisite restaurant", "The child wine five restaurant course exquisite pair meal served five course pair exquisite served restaurant meal Richmond wine five"], "exact_same": false, "prefix_only": false, "too_short": false}
...
{
  "passed": false,
  "case": "leaf_capacity_stability",
  "error": {
    "type": "TypeError",
    "message": "object of type 'int' has no len()",
    "traceback": "Traceback (most recent call last):\n  File \"/workspace/v331_blackbox_eval.py\", line 130, in run_case\n    result = fn(*args, **kwargs)\n             ^^^^^^^^^^^^^^^^^^^\n  File \"/workspace/v331_blackbox_eval.py\", line 583, in leaf_capacity_stability\n    passed = len(violations) == 0 and len(consistency) == 0\n             ^^^^^^^^^^^^^^^\nTypeError: object of type 'int' has no len()\n"
  }
}
```
...
```json
{
  "passed": true,
  "stored_memories": 8,
  "output": "The pianist piano piano Chopin Tutorial Nguyễn Thị Th Chop noct practiced 最近这段时间，我 practiced noct Chop 的手感到身体很",
  "error": null
}
```
...
```json
{
  ...
  "music_output": "Tell me something about practice and performance. practiced practiced midnight\\n鹿回头deer Recommendation midnight noct nocturnas practice练习 exercised practiced practiced midnight practices performing practicing Tell us",
  "space_output": "Tell me something about practice and performance. spectral stars signatures telescope neb distant captured telescope stars distant captured neb signatures spectral Google\\n spectral stars signatures telescope，\n英语累积",
  "outputs_differ": true,
  "error": null
}
```
...
```json
{
  ...
  "music_output": "Explain what someone should focus on when improving technique and understanding the subject. technique technique refined – blog\\nSkip net refined musician pedal - Page 1 Ref technique technique refined pedal piano technician pianist refined musician musician piano performer\n\n抱歉~",
  "space_output": "Explain what someone should focus on when improving technique and understanding the subject. telescope distant signatures spectral neb stars captured telescope stars distant captured spectral neb --来源Nature signatures distant signatures AB North America captured neb stars stars distant spectrum.背景星空AB",
  "blank_music_score": 0.06666666666666667,
  "blank_space_score": 0.0,
  "music_music_score": 0.5555555555555556,
  "music_space_score": 0.0,
  "space_space_score": 0.14285714285714285,
  "space_music_score": 0.03571428571428571,
  "music_margin": 0.5555555555555556,
  "space_margin": 0.10714285714285714,
  "music_lift": 0.48888888888888893,
  "space_lift": 0.14285714285714285,
  "error": null
}
```
  ...
  "rows": [
    {
      ...
      "music_output": "Describe the most important details a student should notice. dynamics often rub depends interpretation touch tempo dynamics touch depends often tempo rub interpretation drum dynamics often rub depends interpretation touch depend dyn touch depends often Touch",
      "space_output": "Describe the most important details a student should notice. neb telescope distant stars captured signatures spectral signatures stars distant captured nebulas Ryan Men spectral neb distant stars captured signatures dwarf galaxies stars distant captured infrared",
      "music_margin": 0.0,
      "space_margin": 0.17857142857142858,
      "passed": false
    },
    {
      "prompt": "Summarize the key ideas a learner should practice and remember.",
      "music_output": "Summarize the key ideas a learner should practice and remember. interpretation tempo depends often depends dynamics rub touch touch often rub dynamics tempo interpretation a learner interpretation tempo depends\n西安交应在____ touch touch depends recur",
      "space_output": "Summarize the key ideas a learner should practice and remember. telescope neb signatures captured spectral signatures telescope neb captured spectral starscapes\r\nPython  stars neb signatures captured spectral\\n\"\n`` captured signatures starscape",
      "music_margin": 0.0,
      "space_margin": 0.0,
      "passed": false
    }
...
```json
{
  ...
  "metrics": [
    {
      "prompt": "The pianist",
      "output": "The pianist pian pian Chopin Trio Performance el . Chop noct midnight的文件主人貴川 pian pian Chop在google图书是什么意思 Chop noct noct midnight",
      "token_count": 17,
      "unique_token_ratio": 0.5294117647058824,
      "repeated_bigram_ratio": 0.1875,
      "max_token_run": 2,
      "punct_ratio": 0.007751937984496124,
      "newline_ratio": 0.0,
      "alpha_ratio": 0.8527131782945736,
      "content_token_ratio": 0.9411764705882353,
      "generated_preview": "pian pian chopin trio performance el chop noct midnight pian pian chop google chop noct noct midnight"
    },
    {
      "prompt": "The telescope",
      "output": "The telescope telescope telescope stars search machine ____visitedvisit stars neb captured visit google______;\n填 captured neb stars\n\n音乐家们如何 stars neb captured telescope",
      "token_count": 18,
      "unique_token_ratio": 0.5,
      "repeated_bigram_ratio": 0.11764705882352941,
      "max_token_run": 2,
      "punct_ratio": 0.06547619047619048,
      "newline_ratio": 0.017857142857142856,
      "alpha_ratio": 0.8035714285714286,
      "content_token_ratio": 0.8333333333333334,
      "generated_preview": "telescope telescope stars search machine visitedvisit stars neb captured visit google captured neb stars stars neb captured telescope"
    },
    {
      "prompt": "The forest path",
      "output": "The forest path tempo touch rub dynamics depends often interpretation touch depends often rub dynamics interpretation tempo粉音乐 tempo touch rub dynamics depends often interpretation cc touch depends often触摸",
      "token_count": 25,
      "unique_token_ratio": 0.32,
      "repeated_bigram_ratio": 0.4166666666666667,
      "max_token_run": 2,
      "punct_ratio": 0.0,
      "newline_ratio": 0.0,
      "alpha_ratio": 0.8682926829268293,
      "content_token_ratio": 0.68,
      "generated_preview": "tempo touch rub dynamics depends often interpretation touch depends often rub dynamics interpretation tempo tempo touch rub dynamics depends often interpretation cc touch depends"
    },
    {
      "prompt": "The market analyst",
      "output": "The market analyst market market volatility弹性協定をどのように volatility stock experienced variableを得るかについて experienced market volatility stock elasticit volatile python volatility market experienced variation",
      "token_count": 18,
      "unique_token_ratio": 0.5,
      "repeated_bigram_ratio": 0.11764705882352941,
      "max_token_run": 2,
      "punct_ratio": 0.0,
      "newline_ratio": 0.0,
      "alpha_ratio": 0.900497512437811,
      "content_token_ratio": 1.0,
      "generated_preview": "market market volatility volatility stock experienced variable experienced market volatility stock elasticit volatile python volatility market experienced variation"
    },
    {
      "prompt": "Explain the topic clearly",
      "output": "Explain the topic clearly simple everyday explained professor rel analog simple everyday explained rel professor analog谷歌chat简单易 simple everyday explained\\rponceardo的Ex explained simple rel professor",
      "token_count": 22,
      "unique_token_ratio": 0.4090909090909091,
      "repeated_bigram_ratio": 0.23809523809523808,
      "max_token_run": 1,
      "punct_ratio": 0.005025125628140704,
      "newline_ratio": 0.0,
      "alpha_ratio": 0.8844221105527639,
      "content_token_ratio": 0.6363636363636364,
      "generated_preview": "simple everyday explained professor rel analog simple everyday explained rel professor analog chat simple everyday explained rponceardo ex explained simple rel professor"
    }
  ],
  "aggregate": {
    "avg_unique_token_ratio": 0.45170053475935834,
    "avg_repeated_bigram_ratio": 0.2155112044817927,
    "avg_content_token_ratio": 0.818174688057041,
    "avg_newline_ratio": 0.0035714285714285713,
...
```json
{
  "passed": true,
  "aggregate": {
    "bad_segment_ratio": 0.05263157894736842,
    "total_segments": 19,
    "bad_segments": 1,
  ...
  "rows": [
    ...
    {
      "prompt": "The telescope",
      "output": "The telescope telescope telescope stars night sky 🙄 stars neb spectral classification IIIb是什么意思 spectral neb stars夜怎么了_百度 stars neb spectral class️ESA\n答 telescope spectral stars night sky指的是“同步 stars neb spectral classification IIIb”。这个",
    ...
    {
      "prompt": "The market analyst",
      "output": "The market analyst market market volatility measures______预期未来 volatility stock experienced. Answer D Expected past experienced market volatility stock． Correct answerer volatility market experienced experience Experience\n最佳答案 experienced market volatility stock。Experience The correct volatility market experienced.\n\n1、背景中国",
    ...
    {
      "prompt": "Explain the topic clearly",
      "output": "Explain the topic clearly simple everyday explained simple analog rel professor explained rel professor everyday analog clocks Google Scholar\\n simple everyday explained simple analog rel professor html explained rel professor practiced everday analog Er simple everyday explained button easy Professor of Analog explained simple rel google scholar er Ever Everyday",
  ...
  "rows": [
    {
      ...
      "output": "What improves piano technique and musical phrasing? technique piano technique piano musician Pierre Boué musician pedal refined the structure of a musical technique refined technique?\n提高。\nA. musician musician refined。",
      "music_score": 0.6363636363636364,
      "space_score": 0.0,
    ...
    },
    {
      ...
      "output": "What explains satellites and orbital motion? explains satellites explains satellites move in orbit because move planets gravitational pull\nplanets explain gravitational explains explains planets move< satellites ] move planets gravitational\n\n",
      "music_score": 0.0,
      "space_score": 0.38461538461538464,
    ...
    },
    {
      ...
      "output": "Summarize the subject with concrete domain details. stars telescope distant neb signatures spectral captured neb stars distant captured signatures spectral captures telescope capture stars telescope distant starlight signatures stellar captured stars distant captured light",
      "music_score": 0.0,
      "space_score": 0.16666666666666666,
      "generated_label": "space",
...
```json
{
  ...
  "correlations": {
    ...
    "retrieval_strength__bad_decode_score": -0.7101970760895931,
  ...
  "rows": [
    {
      ...
      "rows": [
        ...
        },
        {
          ...
          "retrieved_score_sum": {
            "space": -0.13860692083835602,
            "music": -0.07655031979084015
          },
          "logits_label_mass": {
            "music": 0,
            "space": 0
    ...
    },
    {
      ...
      "rows": [
        ...
        },
        {
          ...
          "retrieved_score_sum": {
            "space": 0.13603028655052185,
            "music": 0.008594527840614319
          },
          "logits_label_mass": {
            "music": 0,
...
```json
{
  ...
  "outputs": [
    "The pianist Hannah wants balloons proportional weights totaling $S dollars cheaper compared to 5 cookies． Mar needs",
    "Quantum systems cryptography aims towards computing that runs probabilistically prob\tCon\tcpu-efficiently（高效地 DDS\thttp",
    "The rainforest chicken Cass spp是喜温带季 windy creek whales是什么时候灭绝的原因 wiki verified"
  ],
  "unique_count": 3,
  "error": null
}
...
```json
{
  "passed": true,
  "prompt": "The pianist",
  "output_a": "The pianist piano piano Chopin ethe pianist Chop noct practiced several hours every day epsilon practiced noct",
  "output_b": "The pianist piano piano Chopin ethe pianist Chop noct practiced several hours every day epsilon practiced noct",
  "error": null
}
```
...
```json
{
  "passed": true,
  "outputs": [
    "The pianist piano piano Chopinのレビュー・感 Chop noct practiced practicing hands\r\nff octave practiced noct",
    "The telescope restaurant exquisite wine pair meal course five served five course pair restaurant exquisite meal served mp wine restaurant",
    "The trader exquisite restaurant meal course wine pair five course five pair wine exquisite meal restaurant Richmond | exquisite restaurant",
    "The child wine five restaurant course exquisite pair meal served five course pair exquisite served restaurant meal Richmond wine five"
  ],
  "exact_same": false,
  "prefix_only": false,
  "too_short": false,
