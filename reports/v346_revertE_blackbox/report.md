...
- `PASS` `no_grad_generation`: {"stored_memories": 8, "output": "The pianist piano hours piano perfect piano practiced Chopsticks difficult Chop Chop practiced practiced perfect Chop perfect hours hours difficult hours perfect difficult piano Chop"}
- `PASS` `counterfactual_memory_influence`: {"prompt": "Tell me something about practice and performance.", "music_output": "Tell me something about practice and performance. Options later snow Leopard midnight Practice refers generally practiced midnight taught Mahmoud:Hello, teacher Cons tells midnight practiced.\nGeneratedConserve", "space_output": "Tell me something about practice and performance. Options group isAdmin extends Controller { fun space Observatory observed telling spacePerformance.observe(redChannel space evolution ADMIN_ACCESS_TOKEN=\"@ADMIN_API", "outputs_differ": true}
- `PASS` `semantic_memory_grounding`: {"prompt": "Explain what someone should focus on when improving technique and understanding the subject.", "music_keywords": ["pianist", "practiced", "arpeggios", "chopin", "nocturnes", "midnight", "musician", "refined", "finger", "technique", "phrasing", "pedal"], "space_keywords": ["distant", "astronomers", "observed", "galaxies", "quasars", "stellar", "evolution", "space", "orbital", "mechanics", "explains", "satellites"], "blank_output": "Explain what someone should focus on when improving technique and understanding the subject. Ohio Wesley Moo...\\ennocabularized explanation? Explain exactly enough technique tips.**\n\n  - Identify **muscle groups engaged**: Emphasis:\n\n- Hip flex", "music_output": "Explain what someone should focus on when improving technique and understanding the subject. control Explain technique controlcontrol Understanding technique improvement finger Improve technique control control technique technique finger piano finger finger control finger technique pedal control pedal piano pedal refinedexplainrefined piano", "space_output": "Explain what someone should focus on when improving technique and understanding the subject. force explains mechanics move
- `FAIL` `semantic_memory_counterfactual_pairs`: {"rows": [{"prompt": "Describe the most important details a student should notice.", "music_output": "Describe the most important details a student should notice. Conservation descriptions provide student conserv specialists (arch conserv conserv keyboardDescribe\nkeyboard describe:\n\n keyboard studied Describe \"study described\":\n\n** scales describes student keyboard", "space_output": "Describe the most important details a student should notice. large Describe helps break apart structure, roles scale describe xml scalescaledescribe.com\n\n structure studies describes scale scale study studyst studies expansion\tdescribe large", "music_margin": 0.0, "space_margin": 0.0, "passed": false}, {"prompt": "Summarize the key ideas a learner should practice and remember.", "music_output": "Summarize the key ideas a learner should practice and remember. touch summarize onTouchSummarize(java.nio depends Sum dependsExtract(key) {\ndepends interpretation touch depends() { \nreturn Arrays interpretation tempo summarizes:\n\n", "space_output": "Summarize the key ideas a learner should practice and remember. large summarize Kotlin LargeSummarizer structure scale Sum summarizing Key large kotli
- `FAIL` `degeneration_quality`: {"metrics": [{"prompt": "The pianist", "output": "The pianist pian pian midnight Pell pian Ell night pian noct midnight practiced midnight midnight pianian noct practiced practiced noct noct pian practiced midnight Hours Jackson Chop Shop.\\", "token_count": 26, "unique_token_ratio": 0.46153846153846156, "repeated_bigram_ratio": 0.04, "max_token_run": 2, "punct_ratio": 0.010526315789473684, "newline_ratio": 0.0, "alpha_ratio": 0.8473684210526315, "content_token_ratio": 0.9230769230769231, "generated_preview": "pian pian midnight pell pian ell night pian noct midnight practiced midnight midnight pianian noct practiced practiced noct noct pian practiced midnight hours jackson"}, {"prompt": "The telescope", "output": "The telescope telescope stars telescope css codes - Meaning, captured telescope telescope stars telescope , stars stars signatures captured captured stars captured telescope signature captured spectral signatures signatures telescope", "token_count": 25, "unique_token_ratio": 0.36, "repeated_bigram_ratio": 0.16666666666666666, "max_token_run": 2, "punct_ratio": 0.012875536480686695, "newline_ratio": 0.0, "alpha_ratio": 0.8669527896995708, "content_token_ratio": 0.96, "ge
...
- `PASS` `repetition_segment_audit`: {"aggregate": {"bad_segment_ratio": 0.08333333333333333, "total_segments": 24, "bad_segments": 2, "early_collapse_prompts": []}, "rows": [{"prompt": "The pianist", "output": "The pianist pian piano hours pian pian 做 perfect hours piano pianedo piano piano hours difficult perfect perfect pian perfect piano perfect hours midnight difficult difficult pian difficult hours perfect difficult practiced midnight midnight nocturnal midnight practiced � noct noct practiced practiced noct midnight practiced difficult", "generated_token_count": 42, "window": 8, "segments": [{"segment_idx": 0, "tokens": ["pian", "piano", "hours", "pian", "pian", "perfect", "hours", "piano"], "unique_ratio": 0.5, "content_ratio": 0.75, "repeated_bigram_ratio": 0.0, "dominant_token_share": 0.375}, {"segment_idx": 1, "tokens": ["pianedo", "piano", "piano", "hours", "difficult", "perfect", "perfect", "pian"], "unique_ratio": 0.75, "content_ratio": 0.875, "repeated_bigram_ratio": 0.0, "dominant_token_share": 0.25}, {"segment_idx": 2, "tokens": ["perfect", "piano", "perfect", "hours", "midnight", "difficult", "difficult", "pian"], "unique_ratio": 0.75, "content_ratio": 0.875, "repeated_bigram_ratio": 0.0, "dominant_t
...
- `PASS` `save_load_consistency`: {"prompt": "The pianist", "output_a": "The pianist piano hours piano piano practiced piano noct piano perfect noct hours practiced hours noct practiced noct difficult perfect", "output_b": "The pianist piano hours piano piano practiced piano noct piano perfect noct hours practiced hours noct practiced noct difficult perfect"}
- `PASS` `training_cache_isolation`: {"changed": [], "memory_count": 8}
- `PASS` `cheating_heuristics`: {"outputs": ["The pianist practiced piano hours per day．hours的力量 perfect hours hours practiced practiced hours piano piano difficult perfect", "The telescope hours practiced difficult perfect piano Chop noct piano perfect noct difficult piano hourscourse perfect practiced Chop hours", "The trader market stock volatility significant experienced market session market volatility stock stock market significant session experienced volatility experienced significant", "The child rel explained course restaurant everyday professor simple stop professor analog explained simple everyday rel curso professor served rel"], "exact_same": false, "prefix_only": false, "too_short": false}
...
- `FAIL` `decode_repetition_feedback_probe`: {"status": "fail", "per_prompt": [{"prompt": "The telescope", "output": "The telescope telescope stars telescope telescope neb telescope jag Wire captured Mouse capturedGame savedTextFile captures signatures captured signatures signed stars neb stars Jag spectral Images signatures signatures images neb", "max_repeat_per_content_token": 4, "first_bigram_repeat_index": null, "trigram_lock_count": 0}, {"prompt": "The pianist", "output": "The pianist pian piano pian pian hours pian Tao pian perfect hours hours perfectperfectAppPerfectSoftware difficult perfect perfect App easy hours software Software midnight difficult difficult\n\n# \n", "max_repeat_per_content_token": 5, "first_bigram_repeat_index": null, "trigram_lock_count": 0}, {"prompt": "The market analyst", "output": "The market analyst market session market market stock market volatility market significant volatility stock session session stock SignificantBank experienced trusted Experienced trust Bank bank deposit experience experienced experienced significant significant experienced volatility", "max_repeat_per_content_token": 5, "first_bigram_repeat_index": null, "trigram_lock_count": 0}], "avg_max_repeat_per_content_token"
...
- `PASS` `prefix_length_scaling_probe`: {"status": "pass", "metric_version": "v3.45", "L_mem_A": 8, "L_mem_B": 16, "avg_mass_ratio_B_over_A": 1.5437594019237795, "per_prompt": [{"prompt": "A strong explanation should mention", "starter_mass_A": 27261.060546875, "starter_mass_B": 26381.375, "ratio": 0.9677310592754675, "content_starters_top12_A": 12, "content_starters_top12_B": 12, "per_slot_mean_norm_A": 1.0251210778951645, "per_slot_mean_norm_B": 1.0251210927963257}, {"prompt": "The pianist", "starter_mass_A": 9274.1611328125, "starter_mass_B": 24396.36328125, "ratio": 2.6305735830849764, "content_starters_top12_A": 12, "content_starters_top12_B": 12, "per_slot_mean_norm_A": 1.0251211524009705, "per_slot_mean_norm_B": 1.0251211449503899}, {"prompt": "The telescope", "starter_mass_A": 16886.515625, "starter_mass_B": 17443.32421875, "ratio": 1.0329735634108945, "content_starters_top12_A": 12, "content_starters_top12_B": 12, "per_slot_mean_norm_A": 1.0251210927963257, "per_slot_mean_norm_B": 1.0251211151480675}], "conditions": {"avg_mass_ratio_gt_1_10": true, "per_slot_norms_finite": true}, "gating": "PASS_or_not_implemented"}
...
```json
{
  "passed": true,
  "stored_memories": 8,
  "output": "The pianist piano hours piano perfect piano practiced Chopsticks difficult Chop Chop practiced practiced perfect Chop perfect hours hours difficult hours perfect difficult piano Chop",
  "error": null
}
```
...
```json
{
  ...
  "music_output": "Tell me something about practice and performance. Options later snow Leopard midnight Practice refers generally practiced midnight taught Mahmoud:Hello, teacher Cons tells midnight practiced.\nGeneratedConserve",
  "space_output": "Tell me something about practice and performance. Options group isAdmin extends Controller { fun space Observatory observed telling spacePerformance.observe(redChannel space evolution ADMIN_ACCESS_TOKEN=\"@ADMIN_API",
  "outputs_differ": true,
  "error": null
}
```
...
```json
{
  ...
  "metrics": [
    {
      "prompt": "The pianist",
      "output": "The pianist pian pian midnight Pell pian Ell night pian noct midnight practiced midnight midnight pianian noct practiced practiced noct noct pian practiced midnight Hours Jackson Chop Shop.\\",
      "token_count": 26,
      "unique_token_ratio": 0.46153846153846156,
      "repeated_bigram_ratio": 0.04,
      "max_token_run": 2,
      "punct_ratio": 0.010526315789473684,
      "newline_ratio": 0.0,
      "alpha_ratio": 0.8473684210526315,
      "content_token_ratio": 0.9230769230769231,
      "generated_preview": "pian pian midnight pell pian ell night pian noct midnight practiced midnight midnight pianian noct practiced practiced noct noct pian practiced midnight hours jackson"
    },
    {
      "prompt": "The telescope",
      "output": "The telescope telescope stars telescope css codes - Meaning, captured telescope telescope stars telescope , stars stars signatures captured captured stars captured telescope signature captured spectral signatures signatures telescope",
      "token_count": 25,
      "unique_token_ratio": 0.36,
      "repeated_bigram_ratio": 0.16666666666666666,
      "max_token_run": 2,
      "punct_ratio": 0.012875536480686695,
      "newline_ratio": 0.0,
      "alpha_ratio": 0.8669527896995708,
      "content_token_ratio": 0.96,
      "generated_preview": "telescope stars telescope css codes meaning captured telescope telescope stars telescope stars stars signatures captured captured stars captured telescope signature captured spectral signatures signatures"
    },
    {
      "prompt": "The forest path",
      "output": "The forest path space galaxies observed thus far ______ distant stellar evolution space stellar galaxies galaxies distant observed observed space observed stellar evolution evolution observed________ space space distant distant galaxies",
      "token_count": 26,
      "unique_token_ratio": 0.3076923076923077,
      "repeated_bigram_ratio": 0.08,
      "max_token_run": 2,
      "punct_ratio": 0.059322033898305086,
      "newline_ratio": 0.0,
      "alpha_ratio": 0.8177966101694916,
      "content_token_ratio": 0.9615384615384616,
      "generated_preview": "space galaxies observed thus far distant stellar evolution space stellar galaxies galaxies distant observed observed space observed stellar evolution evolution observed space space distant"
    },
    {
      "prompt": "The market analyst",
      "output": "The market analyst market session market market volatility market stock market significant stock session session volatility volatility stock stock experienced session significant significant volatility session stock volatility experienced experienced significant experienced",
      "token_count": 28,
      ...
      "generated_preview": "market session market market volatility market stock market significant stock session session volatility volatility stock stock experienced session significant significant volatility session stock volatility"
    },
    {
      "prompt": "Explain the topic clearly",
      "output": "Explain the topic clearly rel explained simple analog Compare cucina semp rel professor explained analog simple explained rel analog everyday explained professor simple rel simple professor analog explained everyday rel Force",
      "token_count": 27,
      ...
      "punct_ratio": 0.0,
      "newline_ratio": 0.0,
      "alpha_ratio": 0.8666666666666667,
      "content_token_ratio": 0.6666666666666666,
      "generated_preview": "rel explained simple analog compare cucina semp rel professor explained analog simple explained rel analog everyday explained professor simple rel simple professor analog explained"
    }
  ],
  "aggregate": {
    "avg_unique_token_ratio": 0.3427773707773708,
    "avg_repeated_bigram_ratio": 0.05733333333333333,
    "avg_content_token_ratio": 0.8665421245421246,
...
```json
{
  ...
  "rows": [
    {
      "prompt": "The pianist",
      "output": "The pianist pian piano hours pian pian 做 perfect hours piano pianedo piano piano hours difficult perfect perfect pian perfect piano perfect hours midnight difficult difficult pian difficult hours perfect difficult practiced midnight midnight nocturnal midnight practiced � noct noct practiced practiced noct midnight practiced difficult",
    ...
    {
      "prompt": "The telescope",
      "output": "The telescope telescope telescope stars telescope edu telescope 教 captured teh telescope gele 所 stars stars signatures stars captured captured stars telescope captured signatures spectral signatures signatures captured telescope signatures stars spectral distant spectral spectral captured spectral distance 敬 distant distant captured distant space distant signatures\n\n",
    ...
    {
      "prompt": "The market analyst",
      "output": "The market analyst market market session market analyst 能组成的 market significant session session market session significant review stock significant significant market significant session neo market experienced stock stock session stock market stock experienced volatility experienced significant experienced session experienced volality volatility volatility stock volatility significant volatility\n\nBased",
    ...
    {
      "prompt": "Explain the topic clearly",
      "output": "Explain the topic clearly simple everyday explained professor rel analog simple simple rel everyday analog relforce explained everyday professor simple explained rel simple analog explained everyday professor explained simple rel professor analog everyday rel explained analog professor everyday simple explained rel analog simplified everyday professor professor forcediego rel\n\nTranslate",
  ...
  "rows": [
    {
      ...
      "output": "What improves piano technique and musical phrasing? piano technique controlenh technique pianocontrol piano finger piano control technique musician control piano pedal finger pedal refined是什么 refine technique finger control musician pedal refined night",
      "music_score": 0.5333333333333333,
      "space_score": 0.0,
    ...
    },
    {
      ...
      "output": "What explains satellites and orbital motion? satellites explains force Force explains satellites satellites move force move mechanics move gravitational force explains planets planets gravitational mechanics planets move planets mechanics gravitational gravitational satellites mechanics force",
      "music_score": 0.0,
      "space_score": 0.4375,
    ...
    },
    {
      ...
      "output": "Summarize the subject with concrete domain details. large summarize matter structure scale universe studies dark matter expansion Sum matter universe dark studies scale cons expansion dark large structure universe scale studies large matter dark structure",
      "music_score": 0.0,
      "space_score": 0.0,
...
```json
{
  "passed": true,
  "prompt": "The pianist",
  "output_a": "The pianist piano hours piano piano practiced piano noct piano perfect noct hours practiced hours noct practiced noct difficult perfect",
  "output_b": "The pianist piano hours piano piano practiced piano noct piano perfect noct hours practiced hours noct practiced noct difficult perfect",
  "error": null
}
```
...
```json
{
  "passed": true,
  "outputs": [
    "The pianist practiced piano hours per day．hours的力量 perfect hours hours practiced practiced hours piano piano difficult perfect",
    ...
    "The trader market stock volatility significant experienced market session market volatility stock stock market significant session experienced volatility experienced significant",
    "The child rel explained course restaurant everyday professor simple stop professor analog explained simple everyday rel curso professor served rel"
  ],
  "exact_same": false,
  "prefix_only": false,
  "too_short": false,
