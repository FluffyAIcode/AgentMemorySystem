...
```json
{
  ...
  "training_info": {
    ...
    "grad_norms": {
      "ctx_encoder": 0.0007482955834986632,
      "fib_encoder": 0.19660018691164025,
      "dir_predictor": 0.0,
      "fiber_connection": 0.07661829185392771,
      "fiber_attn": 0.00013148285868965008,
      "reranker": 5.52594681839923e-09,
      "qformer": 0.005854448311448022,
      "content_bypass": 0.008791142280694369,
      "semantic_probe": 0.0,
      "layer_pool": 0.0030069095082581043,
      "prefix_aligner": 0.004749588155588048,
      "vocab_proj": 0.03436705472371626,
      "tail_head": 0.16487830830430264,
      "context_heads": 0.026188182377349163,
      "memory_context_encoder": 0.03793565451750877
    },
    "loss_weights": {
      "recon": 1.0,
  ...
  "metric_grad_norms": [
    0.0007958946516737342,
    2.973346818180289e-05,
    0.0009105465724132955,
    4.117561911698431e-05,
    0.006046487018465996,
    0.00030091271037235856
  ],
  "metric_param_deltas": [
    0.0015341672115027905,
    0.0005292510613799095,
    0.0029746827203780413,
    0.0005602684686891735,
    0.003384604351595044,
    0.0005996397230774164
  ],
  "max_metric_grad_norm": 0.006046487018465996,
  "max_metric_param_delta": 0.003384604351595044,
  "error": null
}
```
